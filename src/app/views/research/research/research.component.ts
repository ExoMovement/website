...
export class ResearchComponent implements OnInit {
  ...
  constructor() { 
    ...
    this.timeline = [
      ...
      new Description("fa-person", "", "Feb 2018", "Dylan Finn enters project; 1st 3D print begins for Mark 1", ""),
      new Description("fa-skull-crossbones", "", "May 2018", "Mark 1 scraped", ""),
      ...
      new Description("fa-skull-crossbones", "", "Jul 2019", "Mark 2 scrapped", ""),
      new Description("fa-dollar-sign", "", "Sep 2019", "New funding, Mark 3 began", ""),
      new Description("fa-layer-group", "", "Jan 2020", "1st CNC machined part created", ""),
      new Description("fa-virus-covid", "", "2020", "COVID, minimal work, gained a Sean", ""),
      new Description("fa-building", "", "May 2021", "Incorporated company", ""),
      new Description("fa-bell-concierge", "", "Jun 2021", "Began offering services to generate revenue", ""),
